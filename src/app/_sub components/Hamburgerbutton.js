...
export const HamburgerButton = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      details: "Let's connect! Reach out via form or social links.",
      svg: (
        <svg
          width="28"
          height="29"
        ...
        >
          <path
            d="M7 20.3333C7 18 11.6667 16.7167 14 16.7167C16.3333 16.7167 21 18 21 20.3333V21.5H7M17.5 11C17.5 11.9283 17.1313 12.8185 16.4749 13.4749C15.8185 14.1313 14.9283 14.5 14 14.5C13.0717 14.5 12.1815 14.1313 11.5251 13.4749C10.8687 12.8185 10.5 11.9283 10.5 11C10.5 10.0717 10.8687 9.1815 11.5251 8.52513C12.1815 7.86875 13.0717 7.5 14 7.5C14.9283 7.5 15.8185 7.86875 16.4749 8.52513C17.1313 9.1815 17.5 10.0717 17.5 11ZM3.5 6.33333V22.6667C3.5 23.2855 3.74583 23.879 4.18342 24.3166C4.621 24.7542 5.21449 25 5.83333 25H22.1667C22.7855 25 23.379 24.7542 23.8166 24.3166C24.2542 23.879 24.5 23.2855 24.5 22.6667V6.33333C24.5 5.71449 24.2542 5.121 23.8166 4.68342C23.379 4.24583 22.7855 4 22.1667 4H5.83333C5.21449 4 4.621 4.24583 4.18342 4.68342C3.74583 5.121 3.5 5.71449 3.5 6.33333Z"
            fill={`${pathname === "/contact" ? "#FAFAFA" : "#B0B0B0"}`}
          />
        </svg>
      ),
    },
