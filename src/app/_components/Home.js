...
function Home() {
  return (
    <section className="mx-auto flex flex-col items-center font-outfit  text-primary pt-25 px-10 max-sm:px-5 lg:px-0">
      <div className="glow-text sm:text-[16px]  max-[428px]:!text-[12px] max-sm:text-[14px] font-semibold   p-2 border bg-[#161616]/40  text-primary border-[#313131] rounded-full ">
